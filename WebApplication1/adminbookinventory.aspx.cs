    ...
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        void updateBookByID()
        {
            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE book_master_tbl set book_name=@book_name, genre=@genre, author_name=@author_name, publisher_name=@publisher_name, publish_date=@publish_date, language=@language, edition=@edition, book_cost=@book_cost, number_pages=@number_pages, book_description=@book_description, actual_stock=@actual_stock, current_stock=@current_stock, book_img_link=@book_img_link where book_id='" + TextBox1.Text.Trim() + "'", con);
                    ...
                    cmd.Parameters.AddWithValue("@number_pages", TextBox11.Text.Trim());
        ...
        void getBookByID()
        {
            try
            {
                ...
                if (dt.Rows.Count >= 1)
                {
                    ...
                    TextBox11.Text = dt.Rows[0]["number_pages"].ToString().Trim();
        ...
        void addNewBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tbl(book_id,book_name,genre,author_name,publisher_name,publish_date,language,edition,book_cost,number_pages,book_description,actual_stock,current_stock,book_img_link) values(@book_id,@book_name,@genre,@author_name,@publisher_name,@publish_date,@language,@edition,@book_cost,@number_pages,@book_description,@actual_stock,@current_stock,@book_img_link)", con);
